...
<section class="content">
    ...
    <div class="box box-solid box-warning">
        <div class="box-header">
            ...
            <h3 class="box-title"><?php echo 'Event Schedule' ?></h3>
        </div><!-- /.box-header -->
        <div class="box-body">
...
EOF;
            ...
            <div class="row">
                <ul class="legend">
                    <li><span class="holiday"></span> <?php echo 'Holiday' ?></li>
                    <li><span class="importantnotice"></span> <?php echo 'Important Notice' ?></li>
                    <li><span class="meeting"></span> <?php echo 'Meeting' ?></li>
                    <li><span class="messages"></span> <?php echo 'Messages' ?></li>
                </ul>
            </div>
        </div>
    </div>

...
/**
 * This is the model class for table "dok_pembayaran".
 *
 * @property string $id
 ...
 */
class DokPembayaran extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(Bcf15Penyelesaian::className(), ['dok_pembayaran_id' => 'id']);
    }
}

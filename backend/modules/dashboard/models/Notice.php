...
class Notice extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'notice_title' => Yii::t('app', 'Title'),
            'notice_description' => Yii::t('app', 'Description'),
            'notice_user_type' => Yii::t('app', 'User Type'),
            'notice_date' => Yii::t('app', 'Date'),
            'notice_file_path' => Yii::t('app', 'Notice File'),

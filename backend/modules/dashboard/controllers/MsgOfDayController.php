...
use Yii;
use backend\modules\dashboard\models\MsgOfDay;
use backend\modules\dashboard\models\MsgOfDaySearch;
...
class MsgOfDayController extends Controller
{
    ...
    public function actions() 
    {
		...
		'toggle' => [
		    ...
		    'modelClass' => 'backend\modules\dashboard\models\MsgOfDay',
		    'attribute' => 'is_status',
		    'type'=> 'toggle-status',
	...
	$model->updated_at = new \yii\db\Expression('NOW()');
	$model->save();
        \Yii::$app->getSession()->setFlash('success', 'ditampilkan!');
        return $this->redirect(['index']);
    }
	...
	$model->updated_at = new \yii\db\Expression('NOW()');
	$model->save();
        \Yii::$app->getSession()->setFlash('success', 'tidak ditampilkan!');
        return $this->redirect(['index']);
    }
    /**

...
$this->title = Yii::t('app', 'Update Message of Day: ') . ' ' . $model->msg_details;
...
?>
<div class="col-xs-12">
  <div class="col-lg-4 col-sm-4 col-xs-12 no-padding"><h3 class="box-title"><i class="fa fa-edit"></i> <?php echo Yii::t('app', 'Update Message of Day') ?></h3></div>

            ...
            'value' => function ($data) {
                if (\Yii::$app->user->identity->role == 'admin') {
                    if ($data->masuk_tpp == '0') {
                        ...
                        return Html::a("<i class='fa fa-edit fa-2x text-danger text-center'></i>" , ['hanggar/inputba', 'id' => $data->id], [
                                    'class' => '',
                                    'data' => [
                       ...
                       return Html::a("<span class='text-success text-bold '>" .$data->ba_no .' tgl '.$data->ba_tgl . "</span>", ['hanggar/inputba',  'id' => $data->id], [
                                    'class' => '',
                                    'data' => [
                                        'confirm' => 'Pastikan semua barang dari BCF 1.5 nomor : ' . $data->bcf15->bcf15no . ' ini telah masuk ke TPP ' . $data->tpp->namatpp,
                                        'method' => 'post',

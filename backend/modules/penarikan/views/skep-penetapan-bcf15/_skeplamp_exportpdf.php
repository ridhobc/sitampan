            ...
            <div class="col-sm-6 right-side">
                <table class="table table-mailbox table-row " style="font-size: 12px">
                    <tr>
                        ...
                        <td colspan="2">Lampiran Keputusan Kepala <span style="text-transform: capitalize"><?php echo $modelIdentitas['kppbc']; ?></span></td>
                    ...
                    <tr>
                        ...
                        <td width="10%">Nomor</td><td width="20%">: KEP- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $modelskep->skep_no ?></td>
                    </tr>
                    <tr>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <td>Tanggal</td><td>: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <?php $tgl=  explode("-",$modelskep->skep_tgl); $tahun=$tgl[0];$bulan = bulan(date($tgl[1]));  echo $bulan ?> <?php echo $tahun ?></td>
                    </tr>
                    <tr>
                        <td colspan="3" align="center"><h5 >DAFTAR BARANG YANG DINYATAKAN TIDAK DIKUASAI</h5></td>
                    </tr>
